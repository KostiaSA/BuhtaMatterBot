...
const MAX_WEBSOCKET_FAILS = 3000000;
const MIN_WEBSOCKET_RETRY_TIME = 1000; // 3 sec
...
export default class WebSocketClient {
    ...
    initialize(connectionUrl?) {
        ...
        this.conn.onerror = (evt) => {
            console.log("this.conn.onerror",evt);
        ...
        this.conn.onmessage = (evt) => {
            ...
            //console.log("this.conn.onmessage",msg);
            if (msg.seq_reply) {
                if (msg.error) {
